...
.price-table {
  border-radius:  10px;
  padding:        30px;
  box-shadow:     5px 5px 15px 5px hsla(214, 13%, 34%, 0.534);
  height:         100%;
  display:        flex;
}

.price-content { max-width: 300px; }

.four-day { background-color: var(--prices-orange); }
...
.three-day { background-color: var(--prices-red); }
